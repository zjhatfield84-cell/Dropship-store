...
def home():
    ...
    <head>
        ...
        <style>
            ...
            .product { border: 1px solid #ddd; border-radius: 12px; padding: 20px; margin: 15px 0; background: white; }
            button { background: #28a745; color: white; border: none; padding: 12px 25px; font-size: 16px; border-radius: 8px; width: 100%; }
        </style>
    </head>
    <body>
        <div class="container">
